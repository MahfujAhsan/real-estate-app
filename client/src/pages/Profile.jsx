        ...
        {userListings && userListings.length > 0 && (
          <div>
            ...
            {userListings.map((listing) => (
              <div className="rounded-lg p-3 flex justify-between items-center gap-4" key={listing._id}>
                <Link to={`/listing/${listing._id}`}>
                  <img src={listing.imageUrls[0]} alt="listing_cover" className="h-16 w-16 object-contain rounded-lg" />
                </Link>
